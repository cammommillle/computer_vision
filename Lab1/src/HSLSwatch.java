...
public class HSLSwatch extends JPanel implements Observer {
    ...
    private void showErrorDialog(String message) {
        JOptionPane.showMessageDialog(HSLSwatch.this, message, "Invalid Input", JOptionPane.ERROR_MESSAGE);
    }
